	...
	<section class="boardDetail_bgcolor">
		<div class="boardDetail-div-title">
			...
			<div class="boardDetail-div-title-center">			
				<div class="boardDetail-div-title-cate">이벤트</div>
...
<!-- 						<div class="board-option-box-div">
				...
				<div class="boardDetail-div-dateBox">
					<p>시작일 : ${adminEvent.eventStart }</p>
					<p>종료일 : ${adminEvent.eventEnd }</p>
				</div>										
		...
		<div class="boardDetail-div-title titlebox2">
			...
			<div class="boardDetail-div-title-2-2">
				<div class="title-2-2-title">${adminEvent.eventTitle }</div>
				<div class="boardDetail-div-writerBox"></div>
			</div>		
		</div>
 		...
 		<div class="boardDetail-div-content">
			...
			<div>
			 	<img src="${pageContext.request.contextPath }/resources/upload/admin/event/${adminEvent.eventImgRe}" alt="" width="1250px">
				<div></div>
				<p> ${adminEvent.eventContent }</p>
			</div>
